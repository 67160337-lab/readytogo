...
โปรเจกต์นี้เป็นการสร้าง Data Pipeline สำหรับจัดการข้อมูลการขายสินค้า โดยใช้ Python ในการอ่านข้อมูลจาก Excel แล้วนำข้อมูลมาทำความสะอาด ตรวจสอบความถูกต้อง และเก็บลงฐานข้อมูล SQLite

ในโปรเจกต์นี้ใช้แนวคิด ETL ได้แก่

- **Extract** – อ่านข้อมูลจากไฟล์ Excel
- **Transform** – ตรวจสอบและจัดรูปแบบข้อมูล
- **Load** – นำข้อมูลที่ผ่านการตรวจสอบไปเก็บใน Data Warehouse

ข้อมูลการขายถูกแบ่งออกเป็น 3 Batch และมีการแยกข้อมูลที่ผิดพลาดออกไปเก็บใน `quarantine` เพื่อไม่ให้ข้อมูลที่ไม่ถูกต้องเข้าไปอยู่ในตารางยอดขาย
